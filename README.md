...
- If any other database or a different name is used, get the connection string of that database and copy it to the DBInfo file inside tha info package (info>>DBInfo>>DBUrl) and setup the particaular database by importing the .sql file as mentioned above.
